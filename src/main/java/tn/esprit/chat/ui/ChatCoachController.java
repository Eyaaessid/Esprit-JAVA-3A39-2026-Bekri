...
""".trim());
    ...
    @FXML
    private void handleGoCheckIn(ActionEvent e) { UserShellNavigator.navigate(UserShellRoute.SUIVI_TODAY); }

    @FXML
    private void handleGoWeekly(ActionEvent e)  { UserShellNavigator.navigate(UserShellRoute.WEEKLY_INSIGHT); }
