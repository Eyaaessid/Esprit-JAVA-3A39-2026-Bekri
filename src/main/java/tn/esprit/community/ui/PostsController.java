...
public class PostsController {
    ...
    private void refreshFeed() {
        try {
            if (showingSavedOnly) {
                ...
                String cat = categoryComboBox != null ? categoryComboBox.getValue() : "All";
                posts = appState.getPostDao().findAllVisible(q, cat);
            }
            renderFeed();
        } catch (SQLException exception) {
    ...
    private void handleObjectifs() {
        UserShellNavigator.navigate(UserShellRoute.OBJECTIFS);
    }

    @FXML
    private void handleDailyCheckIn() {
        UserShellNavigator.navigate(UserShellRoute.SUIVI_TODAY);
    }

    @FXML
    private void handleWeekPlan() {
        UserShellNavigator.navigate(UserShellRoute.PLAN_WEEKLY);
    }

    @FXML
    private void handleWeeklyInsights() {
        UserShellNavigator.navigate(UserShellRoute.WEEKLY_INSIGHT);
    }
    ...
    private void handleChatBot() {
        UserShellNavigator.navigate(UserShellRoute.CHAT_COACH);
    }

    @FXML
    private void handleTest() {
        UserShellNavigator.navigate(UserShellRoute.TEST_PSY);
    }

    @FXML
    private void handleProfilPsy() {
        UserShellNavigator.navigate(UserShellRoute.PROFIL_PSY);
    }
