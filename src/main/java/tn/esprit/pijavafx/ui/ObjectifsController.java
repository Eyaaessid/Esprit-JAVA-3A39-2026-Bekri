...
public class ObjectifsController {
    ...
    public void initialize() {
        ...
        // Re-layout cards when pane width changes (window resize)
    ...
    /** 3 columns with 20px gaps — fills the row perfectly */
    ...
    private void openForm(ObjectifBienEtreDto existing) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/objectif_form.fxml"));
