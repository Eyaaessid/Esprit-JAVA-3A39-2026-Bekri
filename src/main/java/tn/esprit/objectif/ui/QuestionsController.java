...
import tn.esprit.objectif.service.QuestionEvaluationService;
...
public class QuestionsController {
    ...
    private final QuestionEvaluationService questionService = new QuestionEvaluationService();
    ...
    private void loadCards() {
        try {
            allQuestions = questionService.findAll().stream()
    ...
    private void handleBack() {
        try {
            ...
            showError("Erreur de navigation.", e);
        }
    }
    ...
    private void openForm(QuestionEvaluationDto existing) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/question-form.fxml"));
            ...
            ctrl.setOnSave(dto -> {
                try {
                    QuestionEvaluation entity = ObjectifEntityMapper.toEntity(dto);
                    if (existing == null) {
